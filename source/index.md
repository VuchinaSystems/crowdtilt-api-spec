...
--------- | ------- | -----------
/users | <a href="#list-users">GET</a> <a href="#create-user">POST</a> | List of users
/users/:id | <a href="#get-user">GET</a> <a href="#update-user">PUT</a> | A specific user
/users/:id/verification | <a href="#verify-user">POST</a> | Verify a user to receive payments
/users/:id/campaigns | <a href="#get-user-campaigns">GET</a> | All campaigns this user is admin of
/users/:id/cards | <a href="#list-user-cards">GET</a> <a href="#create-user-card">POST</a> | User credit cards
/users/:id/cards/:id | <a href="#get-user-card">GET</a> <a href="#update-user-card">PUT</a> <a href="#delete-user-card">DELETE</a> | A specific credit card
/users/:id/banks | <a href="#list-user-banks">GET</a> <a href="#create-user-bank">POST</a> | User bank accounts
/users/:id/banks/:id | <a href="#get-user-bank">GET</a> <a href="#update-user-bank">PUT</a> <a href="#delete-user-bank">DELETE</a> | A specific bank account
/users/:id/payments | <a href="#list-user-payments">GET</a> | A list of Users payments</td>
